...
import 'package:final_proj/2.TaskPlanner/features/MyTasks.dart';
import 'package:flutter/services.dart';
import 'package:final_proj/2.TaskPlanner/Task-plan_Sliders/slideItem.dart';
import 'package:final_proj/2.TaskPlanner/Task-plan_Sliders/slide.dart';
import 'dart:async';
import 'package:final_proj/2.TaskPlanner/Task-plan_Sliders/sliders.dart';
...
class TaskPlanner extends StatelessWidget with NavigationStates {
  @override
...
class _ToDoState extends State<ToDo> {
  ...
  void initState() {
    ...
    Timer.periodic(Duration(seconds: 5), (Timer timer) {
      ...
      pageController.animateToPage(_currentslide,
