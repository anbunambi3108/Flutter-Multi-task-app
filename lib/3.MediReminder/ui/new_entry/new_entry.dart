...
import 'package:final_proj/3.MediReminder/common/convert_time.dart';
import 'package:final_proj/3.MediReminder/global_bloc.dart';
import 'package:final_proj/3.MediReminder/models/errors.dart';
import 'package:final_proj/3.MediReminder/models/medicine.dart';
import 'package:final_proj/3.MediReminder/models/medicine_type.dart';
import 'package:final_proj/3.MediReminder/ui/homepage/homepage.dart';
import 'package:final_proj/3.MediReminder/ui/new_entry/new_entry_bloc.dart';
import 'package:final_proj/3.MediReminder/ui/success_screen/success_screen.dart';
      ...
      child: Container(
        child: Row(
          ...
          children: <Widget>[
            ...
            DropdownButton<int>(
              iconEnabledColor: Color(0xFF232e5c),
              hint: _selected == 0
                  ? Text(
                      "Select an Interval",
                      style: TextStyle(
