...
import 'package:final_proj/3.MediReminder/ui/medicine_details/medicine_details.dart';
import 'package:final_proj/3.MediReminder/ui/new_entry/new_entry.dart';
...
class _MedHomePageState extends State<MedHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Color(0xFF232e5c),
        elevation: 0.0,
    ...
    return Container(
      decoration: BoxDecoration(
        borderRadius: BorderRadius.only(
          bottomLeft: Radius.elliptical(45, 27),
          bottomRight: Radius.elliptical(45, 27),
        ),
        boxShadow: [
          BoxShadow(
            blurRadius: 9,
        ...
        children: <Widget>[
          ...
          StreamBuilder<List<Medicine>>(
            ...
            builder: (context, snapshot) {
              return Padding(
                padding: EdgeInsets.only(top: 13.0, bottom: 1),
                child: Center(
                  child: Text(
